...
function sendVerificationCode() {
    ...
    console.log('=== ARIZONA QUIZ CODE GENERATION DEBUG ===');
    ...
    iframe.name = 'hidden-verification-az';
    ...
    form.method = 'POST';
    form.action = 'https://script.google.com/macros/s/AKfycbzDkCQlsWosEdEZqa4EVAm4b4Z8hER2P3ELJLIsUrVzikL8CWGFtUd6BAnau4TL1TbZ/exec';
    ...
    // Add form fields including the generated code and quiz ID
    const fields = {
        firstName: firstName,
        lastName: lastName,
        email: email,
        ...
        quizId: quizId // Add quiz identifier
    };
    ...
    iframe.onload = function() {
        console.log('Google Apps Script response received for Arizona quiz');
    };
